...
import { Dac } from '../../entities/proposals';
import { GetAllMSIGSUseCase } from '../get-all-msigs.use-case';
import { GetDacsInput } from '../../models/msigs.input';
...
let useCase: GetAllMSIGSUseCase;
...
describe('Get All Dacs Unit tests', () => {
  ...
  beforeEach(() => {
    useCase = container.get<GetAllMSIGSUseCase>(GetAllMSIGSUseCase.Token);
  });
  ...
  it('"Token" should be set', () => {
    expect(GetAllMSIGSUseCase.Token).not.toBeNull();
  });
